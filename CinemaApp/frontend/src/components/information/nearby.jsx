...
const Nearby = () =>{
    return(
        <main>
            <h1> Places to go </h1>
            <h3 className="placename">Five Guys</h3>
            ...
            <h3 className="placename">Arcade</h3>
            <div className="places">
            ...
            <h3 className="placename">Westfield</h3>
            <div className="places">
            ...
            <h3 className="placename">Escape Room</h3>
            <div className="places">
            ...
            <Link to="/information/offers"><h3> Want to find out about our fantastic partnership offers? Look no further!</h3></Link>
